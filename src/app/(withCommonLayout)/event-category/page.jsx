...
const Page = () => {
  ...
  const { data: categories, isLoading } = useGetEventCategoriesQuery();
  ...
  return (
    <section className="flex gap-3">
      ...
      <div className="p-6 w-full shadow-lg flex flex-col gap-6">
        <h3 className="text-[#160E4B] font-medium text-2xl">Event Category</h3>
        <Table
      ...
      <div className="w-full flex flex-col gap-6 p-6">
        <h3 className="text-[#160E4B] font-medium text-2xl">
          Add Event Category
        </h3>
