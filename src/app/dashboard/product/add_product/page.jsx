...
export default function ProductForm() {
  ...
  const handleFileChange = (e, id) => {
    ...
    if (file) {
      ...
      setFormData({ ...formData, [id === "preview" ? "featureImage" : "additionalImages"]: file });
    }
  };
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      <form onSubmit={handleSubmit} className="flex gap-4 p-6 rounded-2xl">
        <div className="w-[504px] space-y-4 bg-white shadow-lg p-6 rounded-lg">
          ...
          <div>
            <label className="block">Color <span className="text-red-500">*</span></label>
        ...
        <div className="w-[504px]">
          <div className="space-y-6 bg-white shadow-lg p-6 rounded-lg">
            ...
            <div className="flex flex-col gap-2">
              <label className="block text-base leading-[24px]">Availability<span className="text-[#F82BA9]">*</span></label>
